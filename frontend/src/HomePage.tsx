...
import { Plus, Trash2, Calendar, Layout, ChevronRight, Zap } from 'lucide-react';
...
export const HomePage = () => {
  const { workspaces, createWorkspace, deleteWorkspace, selectWorkspace } = useWorkspaceViewModel();
            ...
            <AnimatePresence>
              {workspaces.map((ws, i) => (
                <motion.div
                  ...
                  style={{
                    background: '#1c1c1c', // Matte background
